...
<?php
  ...
  $username = $_SESSION["username"];
  $user = $pdo->query("SELECT * FROM utilisateur where username='$username'")->fetch();
  $projects = $pdo->query("SELECT * FROM projet where id_utilisateur='".$user["id_utilisateur"]."'")->fetchAll();
            ...
            <div class="main-content">
                <div class="section__content section__content--p30 ">
						...
						<li  class="list-group-item disabled">
                           Sélectioner un projet :
                        </li>
                        <?php
                        foreach ($projects as $project)
                        {  
                            echo "<li  class='list-group-item'> ";
                            echo "<a href='./creerpermanence.php?id_project=".$project['id_projet']."'>";
                            echo "Projet   :   ";
                            echo $project['id_projet']; 
                            echo "</a> </li>";
                        } 
                        ?>
						</ul>
