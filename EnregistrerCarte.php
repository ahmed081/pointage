        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30 ">
						...
						<p>Scanner votre carte</p>
						  <input type="text" class="form-control" id="validationDefault01" placeholder="First name" value="A récuperer dans la BD" disabled>
						  <p>Insérer le n° d’étudiant</p>
						  <input type="text" class="form-control" id="validationDefault01" placeholder="Insérer le n° d’étudiant"  required>
						  <br>
						  <button type="button" class="btn btn-warning centre center col">Ajouter la carte </button>
						</div>							
				</div>
            </div>
            <!-- END MAIN CONTENT-->
