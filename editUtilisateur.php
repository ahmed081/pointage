                ...
                <div class="section__content section__content--p30 ">
                    <div class="form-group col-md-4 ">
                        <form action=<?php echo "./EditUser.php?id=".$id?> method="Post">
                            <p>Nom :</p>
                            <input type="text" class="form-control" name="nom" value=<?php echo $user["n_utilisateur"]?> id="validationDefault01" placeholder="Insérer le nom" required>
                            <p>Prénom :</p>
                            <input type="text" class="form-control" name="prenom" value=<?php echo $user["p_utilisateur"]?>  id="validationDefault01" placeholder="Insérer le Prénom" required>
                            <p>Numéro de téléphone:</p>
                            <input type="text" class="form-control" name="tele"  value=<?php echo $user["noumeroTel"]?>  id="validationDefault01" placeholder="Insérer le Numéro de téléphone" required>
                            <p> Statut de l'utilisateur : </p>
                            <select name="status" value=<?php echo $user["statut"]?>  class=".col-md- form-control ">
                            <option value="administrateur">Administrateur</option>
                            <option value="résponsable">Enseignant résponsable</option>
                            <option value="enseignant">Enseignant </option>
                            </select>
                            <br>
                            <button class="btn btn-warning centre center col">Modifier l'utilisateur </button>
                        </form>
                    </div>
