                ...
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="active has-sub">
                            <a href="sessionIntervenant.php">Lancer une session</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                ...
                <div class="section__content section__content--p30 text-center">
                    ...
                    <br>
                    <input type="text" class=" w-25 p-2 text-center" id="validationDefault01" placeholder="Insérer le n° d’étudiant" required>
                    <br><br>
                    <button type="button" class="btn btn-warning centre center col w-25 p-2">Valider </button>
                    <br><br><br><br><br><br><br>
                    <button type="button" class="btn btn-danger centre center col w-25 p-3">Quitté la session</button>
