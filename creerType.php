<?php
      ...
      if(isset($valider)){ 
        ...
        $sql ="INSERT INTO types (niveau,filiere,parcour) VALUES ('$niveau','$filiere','$parcour')";
        $exec=$pdo->exec($sql);
...
<body class="animsition" onLoad="document.fo.creerType.focus()">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30 ">
                    ...
                    <form name="fo" method="post" action=""> 
                        <p>Niveau :</p>
                        <input type="text" name="niveau"  class="form-control" id="validationDefault01" placeholder="Insérer le niveau" required>
                        <p>Filière :</p>
                        <input type="text" class="form-control" name="filiere"  id="validationDefault01" placeholder="Insérer la filière" required>
                        <p>Parcour:</p>
                        <input type="text" class="form-control" name="parcour"  id="validationDefault01" placeholder="Insérer le parcour" required>
                        
                        <br>
                        <button type="submit" class="btn btn-warning centre center col" name="valider">Ajouter type </button>
                    </form>
                    </div>
